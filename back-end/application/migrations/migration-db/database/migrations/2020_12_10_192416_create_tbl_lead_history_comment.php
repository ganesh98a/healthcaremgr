...
class CreateTblLeadHistoryComment extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_lead_history_comment', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_lead_history_comment');
    }
}
