...
class AlterTblFmsCaseAgainstDetailAsUpdateCommentForAgainstCategory extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('tbl_fms_case_against_detail', function (Blueprint $table) {
            if (Schema::hasColumn('tbl_fms_case_against_detail','against_category')) {
                $table->unsignedSmallInteger('against_category')->unsigned()->comment('1- member of public,2- Member, 3- Participant, 4- ONCALL (General), 5- ONCALL User/Admin, 6- Org, 7-Site')->change();
            } 
        });
    }
