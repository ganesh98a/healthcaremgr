...
class CreateTblOpportunityHistoryComment extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('tbl_opportunity_history_comment')) {
            Schema::create('tbl_opportunity_history_comment', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_opportunity_history_comment');
    }
}
