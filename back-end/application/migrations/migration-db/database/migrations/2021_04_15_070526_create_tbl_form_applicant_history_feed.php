...
class CreateTblFormApplicantHistoryFeed extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_form_applicant_history_feed', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_form_applicant_history_feed');
    }
}
