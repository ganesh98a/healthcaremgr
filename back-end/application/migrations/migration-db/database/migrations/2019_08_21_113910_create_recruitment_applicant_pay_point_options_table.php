...
class CreateRecruitmentApplicantPayPointOptionsTable extends Migration {
     ...
     */
    public function up() {
        Schema::create('tbl_recruitment_applicant_pay_point_options', function (Blueprint $table) {
            $table->increments('id');
    ...
    public function down() {
        Schema::dropIfExists('tbl_recruitment_applicant_pay_point_options');
    }
