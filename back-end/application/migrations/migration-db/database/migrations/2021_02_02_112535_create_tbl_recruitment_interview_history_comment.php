...
class CreateTblRecruitmentInterviewHistoryComment extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('tbl_recruitment_interview_history_comment')) {
            Schema::create('tbl_recruitment_interview_history_comment', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_recruitment_interview_history_comment');
    }
}
