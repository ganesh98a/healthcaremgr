...
class CreateCrmParticipantLineItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('tbl_crm_participant_line_items')) {
            Schema::create('tbl_crm_participant_line_items', function(Blueprint $table)
                {
                    $table->increments('id');
					$table->unsignedInteger('crm_plan_id')->default(0)->comment('tbl_crm_participant_plan auto increment id');
