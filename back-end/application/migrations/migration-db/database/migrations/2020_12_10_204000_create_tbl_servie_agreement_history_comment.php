...
class CreateTblServieAgreementHistoryComment extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_service_agreement_history_comment', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_service_agreement_history_comment');
    }
}
