...
class CreateTblApplicationHistoryFeed extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_application_history_feed', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->bigInteger('history_id')->unsigned()->comment('tbl_application_history.id');
    ...
    {
        Schema::dropIfExists('tbl_application_history_feed');
    }
}
