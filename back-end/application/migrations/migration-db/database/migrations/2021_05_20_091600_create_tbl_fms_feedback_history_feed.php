...
class CreateTblFmsFeedbackHistoryFeed extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if(!Schema::hasTable('tbl_fms_feedback_history_feed')){
            Schema::create('tbl_fms_feedback_history_feed', function (Blueprint $table) {
