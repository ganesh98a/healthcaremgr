...
class CreateTblFmsFeedbackHistoryComment extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('tbl_fms_feedback_history_comment')) {
            Schema::create('tbl_fms_feedback_history_comment', function (Blueprint $table) {
                $table->bigIncrements('id');
                $table->bigInteger('history_id')->unsigned()->comment('tbl_fms_feedback_history.id');
    ...
    {
        Schema::dropIfExists('tbl_fms_feedback_history_comment');
    }
}
