...
class CreateTblRecruitmentApplicantGroupCapQuestionTable extends Migration {
    ...
    public function up() {
        if (!Schema::hasTable('tbl_recruitment_applicant_group_cap_question')) {
            Schema::create('tbl_recruitment_applicant_group_cap_question', function (Blueprint $table) {
                $table->increments('id');
    ...
    public function down() {
        Schema::dropIfExists('tbl_recruitment_applicant_group_cap_question');
    }
