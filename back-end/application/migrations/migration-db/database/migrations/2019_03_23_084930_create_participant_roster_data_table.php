...
class CreateParticipantRosterDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('tbl_participant_roster_data')) {
            Schema::create('tbl_participant_roster_data', function (Blueprint $table) {
                $table->increments('id');
    ...
    {
        Schema::dropIfExists('tbl_participant_roster_data');
    }
}
