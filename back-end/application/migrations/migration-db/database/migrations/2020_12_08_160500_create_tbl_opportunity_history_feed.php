...
class CreateTblOpportunityHistoryFeed extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('tbl_opportunity_history_feed', function (Blueprint $table) {
            if (!Schema::hasTable('tbl_opportunity_history_feed')) {
                Schema::create('tbl_opportunity_history_feed', function (Blueprint $table) {
                    $table->bigIncrements('id');
                    $table->bigInteger('history_id')->unsigned()->comment('tbl_opportunity_history.id');
    ...
    {
        Schema::table('tbl_opportunity_history_feed', function (Blueprint $table) {
            Schema::dropIfExists('tbl_opportunity_history_feed');
        });
    }
}
