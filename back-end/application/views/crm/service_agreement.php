...
<div class="Hero_section">
    <div class="Hero_img">
        ...
        <div class="w-40 pull-right">
                       ...
                       <div class="font-2"><?php echo $crmPDetails['fullname']; ?></div>
                       
                       <div class="font-1 pt-5">NDIS PARTICIPANT NUMBER:</div>
                       <div class="font-2"><?php echo $crmPDetails['ndis_num']; ?></div>
          </div>
          </div>
...
<div class="px-2 py-2 ">
    ...
    <div><?php echo $crmPDetails['fullname']; ?></div>
</div>
...
<div class="py-4">This Service Agreement will commence on <span class="bb-1 px-2">00/00/0000</span> for the NDIS plan <span class="bb-1 px-2">00/00/0000 - 00/00/0000</span></div>
...
<div class="pt-4">Leanne Hyde</div>
...
<tr>
    ...
    <td width="70"><?php echo $crmPDetails['phone']; ?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="70"><?php echo $crmPDetails['email']; ?> <<?php echo $crmPDetails['email']; ?>></td>
  </tr>
  <tr>
    <th width="30">Address</th>
    <td width="70"><?php echo $crmPDetails['address']; ?></td>
  </tr>
</table>
...
<div class="font_1_set"><?php echo $crmPDetails['fullname']; ?></div>
</div>


<div><div class="bt-1 w-35"></div></div>
<div class="font_1_set pt-4">Date</div>
<div style="width:100%; height:120px;"><?php echo date("m/d/Y"); ?></div>
...
<div><div class="bt-1 w-35"></div></div>
<div class="font_1_set pt-4">Date:<?php echo date("m/d/Y"); ?></div>
<?php } ?>