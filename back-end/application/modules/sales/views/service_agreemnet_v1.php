...
<?php if (isset($type) && $type == 'content_2') { ?>
	...
	<div class="px-5 pt-4">
		<span class="f-18 sub-head-sa">Service Agreement</span>
	</div>
	<div class="px-5 pt-3">
		<span class="f-13 pt-2">This Service Agreement is for NDIS Participant:</span>
		<div class="pt-1">
			<table cell-padding="5" class="sa-input-table pt-1" border="1">
				<tr>
				...
				<tr>
					...
					<td class="f-13"><?php if(isset($participant) == true && isset($participant['date_of_birth']) == true && $participant['date_of_birth'] != '' && $participant['date_of_birth'] != '0000-00-00') { echo date('m/d/Y', strtotime($participant['date_of_birth']));} ?></td>
				</tr>
			</table>
		</div>
	</div>
		...
		<div class="pt-1">
			<table cell-padding="5" class="sa-input-table pt-1" border="1">
				<tr>
					...
					<td class="f-13"><?php if(isset($service_agreement) == true && isset($service_agreement['contract_start_date']) == true && $service_agreement['contract_start_date'] != '' && $service_agreement['contract_start_date'] != '0000-00-00 00:00:00') { echo date('m/d/Y', strtotime($service_agreement['contract_start_date']));} ?> </td>
				</tr>
				<tr>
					<td class="f-13" width="40%">For the NDIS Plan:</td>
					<td class="f-13"><?php if(isset($service_agreement) == true && isset($service_agreement['plan_start_date']) == true && $service_agreement['plan_start_date'] != '' && $service_agreement['plan_start_date'] != '0000-00-00 00:00:00') { echo date('m/d/Y', strtotime($service_agreement['plan_start_date']));} ?> to <?php if(isset($service_agreement) == true && isset($service_agreement['plan_end_date']) == true && $service_agreement['plan_end_date'] != '' && $service_agreement['plan_end_date'] != '0000-00-00 00:00:00') { echo date('m/d/Y', strtotime($service_agreement['plan_end_date']));} ?> </td>
				</tr>
			</table>
		</div>
	</div>
	<div class="px-5 pt-4">
		<span class="f-18 sub-head-sa">The NDIS and this Service Agreement</span>
		<p class="pt-2 f-13">
	...
	<div class="px-5">
		<span class="f-18 sub-head-sa">Schedule of Supports</span>
	</div>
	<div class="px-5 pt-2">
		<p class="f-13">
							...
							<?php
								...
								?>							
									<tr>
										...
										<td class="f-13 " align="right">$<?php echo number_format($item->upper_price_limit,2); ?></td>
										<td class="f-13 " align="right">$<?php echo number_format($item->amount,2); ?></td>
									</tr>
							<?php } ?>
							<tr>
								<td class="f-13 text-center" colspan="2"><u class="f-bold">Total Amount:</u></td>
			...
			<div class="px-5 pt-4">
				<table cell-padding="5" class="sa-input-support-table pt-1" border="1">
					<tr>
						...
						<td class="f-13 text-center" align="right">$<?php echo number_format($total_amount,2); ?></td>
					</tr>
				</table>
			</div>
			<?php
	...
	<div class="px-5 pt-4">
		<span class="f-18 sub-head-sa">Participant NDIS Plan Goals</span>
	</div>
	<div class="px-5 pt-2">
		<p class="f-13">
			This Schedule of Supports specifies the agreed supports and costs that will be delivered to the Participant by ONCALL to meet the needs of the participant in line with their stated Goals.
		...
		if(isset($goals) == true && empty($goals) == false) {
			...
			foreach($goals as $val) {
				...
				<div class="px-5 pt-<?php if ($inc_goals > 0) { echo '4'; } else { echo '2'; } ?>">
					<table cell-padding="5" class="sa-input-goal-table pt-1" border="1">
						<tr>
						...
						<tr>
							...
							<td class="f-13"><?php echo $val['outcome'];?></td>
						</tr>
					</table>
				</div>
				<?php
	...
	<div class="px-5 pt-3">
		<span class="f-13 f-bold">Capacity Building Supports</span>
		<p class="pt-2 f-13">
	...
	<div class="px-5 pt-2">
		<p class="pl-4 f-13 f-bold ml-2">
			Support Coordination Only
		</p>
		<p class="pl-5 f-13 f-bold">
	...
	<div class="px-5 pt-2">
		<span class="f-18 sub-head-sa">House Cleaning and other household tasks</span>
	</div>
	<div class="px-5 pt-1">
		<p class="f-13 mb-0">
			Participants will need to provide all cleaning supplies and equipment required to complete the cleaning tasks they have requested. These may include;
		</p>
	</div>
	...
	<div class="px-5 pt-1">
		<p class="f-13">
			Supplies - floor cleaner, general cleaner, bathroom cleaner, toilet cleaner, gloves, windex, disinfectant, sponges, cloths, sponges, scrubbing brushes, and paper towel. 
		</p>
		<p class="f-13 pt-1">
			Equipment – vacuum, mop/bucket, broom, duster  
		</p>
	</div>
	<div class="px-5 pt-2">
		<span class="f-18 sub-head-sa">Pricing</span>
	</div>
	<div class="px-5 pt-2">
		<p class="f-13">
		...
		<ul class="pt-1">
			...
			<li class="f-13 pt-2">Support items prefixed with the letter “T’ are the Temporary Transformation Payment rate.</li>
			...
			<li class="f-13 pt-2">For all Individual and Group, In Home or Community Support, there is a two-hour shift minimum.</li>
			<li class="f-13 pt-2">All scheduled supports that fall on a Public Holiday will be cancelled unless otherwise requested by the Participant/Representative.</li>
		</ul>
	</div>
	<div class="px-5 pt-2">
		<span class="f-13 f-bold">Additional Expenses</span>
	</div>
	<div class="px-5 pt-2">
		<ul>
			...
			<li class="f-13 pt-2">If applicable, cash for any such expense should be provided to the Participant or support worker on the day it is required only. A cash-logbook should be used on the day (by both the support worker and the Participant/Representative) to demonstrate the exchange of cash funds and the support worker will provide a receipt for all expenses, on completion of shift.</li>
		</ul>
	</div>
	<div class="px-5 pt-2">
		<span class="f-13 f-bold">Establishment fee for personal care / community access</span>
	</div>
	<div class="px-5 pt-2">
		<ul>
			<li class="f-13">Participants will have a budget of $750 for Establishment Fees included in their FIRST plan only. ONCALL will claim the establishment fee in line with the NDIS Price guide rules, and if an establishment fee is applicable, it will be listed in the Schedule of Supports in this Service Agreement.</li>
		</ul>
	</div>
	<div class="px-5 pt-2">
		<span class="f-13 f-bold">Cancellations</span>
	</div>
	<div class="px-5 pt-2">
		<ul>
	...
	<div class="px-5 pt-4">
		<span class="f-13 f-bold">Temporary Transformation Payment (TTP)</span>
	</div>
	<div class="px-5 pt-2">
		<ul>
			<li class="f-13">The NDIA introduced the Temporary Transformation Payment (TTP) from 1 July 2019, to provide additional funding to organisations to assist them to transform their business so they could continue to be viable to provide services under the NDIS. The TTP is set at 7.5% decreasing by 1.5% per year.</li>
			<li class="f-13 pt-2">ONCALL adopted the TTP rate for all in-home support and community participant supports as per NDIA’s advice and have agreed to meet all conditions as set out by NDIA to charge TTP.</li>
			<li class="f-13 pt-2">The TTP support item number is the support base number with the addition of the letter T. These support item numbers are outlined in the NDIS Support Catalogue 2019–20, effective 1 July 2019.</li>
		</ul>
	</div>
	<div class="px-5 pt-2">
		<span class="f-18 sub-head-sa">Transport</span>
	</div>
	<div class="px-5 pt-2">
		<p class="f-13 mb-0">
			Core Funding
		...
		<p class="f-13 mb-0">
			ONCALL can provide support workers who use their own vehicle to transport Participants.  NDIA may fund Transport to enable Participants to access disability supports outside their home, and to pay for transport that helps them to achieve their goals in their plan. NDIA are not responsible for any transport costs incurred by Participant/Representative that are not funded in a NDIS Plan.
		</p>
		<p class="f-13 mb-0">
			<span class="f-bold">General Transport</span> is when ‘a participant pays a provider to transport them to an activity that is not itself a support – or a support delivered by another provider’. 
		</p>
		<p class="f-13 mb-0">
			General Transport can only be charged to <u><i>NDIS Assistance with Travel/Transport Arrangements, Transport (02_051_0108_1_1)</i></u> support item’
		</p>
		<ul>
			<li class="f-13">Rate - Non modified vehicle $1.15 per kilometre</li>
		</ul>
		<p class="f-13 mb-0">
			<span class="f-bold">Activity Based Transport</span> is when a ‘participant is transported, to, or from, or as part of a community participation support,’ both the time spent and non-labour costs (kilometres) can be billed. Time is billed using the relevant community participation support item and against the participant’s core budget. 
		</p>
		<p class="f-13 mb-0">
			Non-labour costs (kilometres) is billed to <u><i>NDIS Participation in Community, Social and Civic Activities, Activity Based Travel (04_590_0125_5_1)</i></u> support item at; 
		</p>
		<ul>
			<li class="f-13">Rate - Non modified vehicle $0.85 per kilometre</li>
			<li class="f-13">Rate - Modified vehicle $2.40 per kilometre</li>
		</ul>
		<p class="f-13 mb-0">
			If General or Activity based Transport are included in this Service Agreement, it will state the nominated value as agreed by the Participant/Representative.
		</p>
		<p class="f-13 mb-0">
			ONCALL will not provide Transport (Kilometres) in addition to the agreed value, unless the Participant/Representative requests to put a signed private agreement in place.
		</p>
		<ul>
			<li class="f-13 f-bold">Self-Managed or Private Agreement Transport (Kilometres)</li>
		</ul>
		<p class="f-13 mb-0">
			A private agreement is when the Participant/Representative agrees to pay privately per kilometre and within the standard ONCALL credit terms of 14 days.
		</p>
		<ul class="mb-0">
			<li class="f-13">Rate - Non modified vehicle $1.15 per kilometre</li>
		</ul>
	...
	<div class="px-5 pt-1">
		<p class="f-13 mb-0">
			If Participants select to pay privately for transport (kilometres) a signed service agreement or signed private agreement must be in place. 
		</p>
		<p class="f-13 mb-0">
			Transport will be provided at the request of the Participant/Representative up to the agreed value or until such time as invoices are outstanding by greater than 14 days. At this time, transport will be suspended until the account is settled, support hours will not be affected.
		</p>
		<ul>
			<li class="f-13 f-bold">Public Transport</li>
		</ul>
		<p class="f-13 mb-0">
			If a Participant does not have a companion card, and the support worker cannot ride public transport for free, then it is the Participant/Representative responsibility to pay for the support worker’s public transport costs at the time of using public transport.
		</p>
		<ul>
			<li class="f-13 f-bold">Provider Travel Time</li>
		</ul>
		<p class="f-13 mb-0">
	...
	<div class="px-5 pt-4">
		<span class="f-18 sub-head-sa">Goods and Services Tax</span>
	</div>
	<div class="px-5 pt-2">
		<p class="f-13 mb-0">
	...
	<div class="px-5">
		<span class="f-18 sub-head-sa">Payments</span>
	</div>
	<div class="px-5">
		...
		<table class="sa-input-table" border="1">
			<tr>
				<td class="f-13 f-bold" width="30%" valign="top">NDIA My Place <input type="checkbox" <?php if(isset($payments) == true && isset($payments['managed_type']) == true && $payments['managed_type'] == 1) echo 'checked="true"'; else echo '';?>/></td>
				<td>
			...
			<tr>
				<td class="f-13 f-bold" width="30%" valign="top">Plan-managed <input type="checkbox" <?php if(isset($payments) == true && isset($payments['managed_type']) == true && $payments['managed_type'] == 2) echo 'checked="true"'; else echo '';?>/></td>
				<td>
		...
		<table class="sa-input-table" border="1">
			<tr>
				<td class="f-13 f-bold" width="30%" valign="top">
	...
	<div class="px-5">
		<span class="f-18 sub-head-sa">Responsibilities of Participant/Representative</span>
	</div>
	<div class="px-5 pt-2">
		<p class="f-13">The Participant/Representative agrees to:</p>
		<ul>
	...
	<div class="px-5">
		<span class="f-18 sub-head-sa">How to resolve problems</span>
	</div>
	<div class="px-5 pt-2">
		<p class="f-13 mb-0">ONCALL welcomes feedback. Feedback includes complaints, suggestions for improvement and compliments. Participants/Representatives can request a copy of ONCALL’s Feedback Policy.</p>
	...
	<div class="px-5 pt-4">
		<span class="f-18 sub-head-sa">Conflict of Interest</span>
	</div>
	<div class="px-5 pt-2">
		<p class="f-13 mb-0">ONCALL is a registered provider for a suite of support services under the National Disability Insurance Scheme (NDIS). ONCALL is aware of the potential or real or perceived conflict of interest in performing multiple roles for an individual. </p>
	...
	<div class="px-5 pt-4">
		<span class="f-18 sub-head-sa">Advocacy</span>
	</div>
	<div class="px-5 pt-2">
		<ul class="ul-a">
			<li class="f-13">
	...
	<div class="px-5 pt-4">
		<span class="f-18 sub-head-sa">Changes to this Service Agreement</span>
	</div>
	<div class="px-5 pt-2">
		<p class="f-13 mb-0">If changes to the supports or their delivery are required, the parties agree to discuss and review this Service Agreement. The parties agree that any changes to this Service Agreement will be in writing, signed, and dated by all parties.</p>
	...
	<div class="px-5">
		<span class="f-18 sub-head-sa">Ending this Service Agreement</span>
	</div>
	<div class="px-5 pt-2">
		<p class="f-13 mb-0">Should either party wish to end this Service Agreement 14 days’ notice is required.</p>
	...
	<div class="px-5">
		<span class="f-18 sub-head-sa">Contact Details</span>
	</div>
	<div class="px-5 pt-2">
		<p class="f-13 mb-0">
			<table>
				<tr>
					<td class="sa-sub-border-bottom">
							<?php if(isset($recipient) == true && isset($recipient['name']) == true) { echo $recipient['name'];} ?>
					</td>
					<td class="f-13  pl-3" width="30%">
						can be contacted on:
					</td>
				</tr>
			</table>	
		</p>
		<table cell-padding="5" class="sa-input-goal-table mt-2" border="1">
			<tr>
				<td class="f-13" width="20%">Phone </td>
	...
	<div class="px-5 pt-2">
		<p class="f-13 mb-0">ONCALL can be contacted on:</p>
		<table class="sa-input-table" border="1">
			<tr>
	...
	<div class="px-5">
		<span class="f-18 sub-head-sa">Service Agreement Signatures</span>
	</div>
	<div class="px-5 mt-2">
		<table class="sa-info-table">
			<tr>
		...
		<p class="f-13 pt-2">The Parties agree to the terms and conditions of this Service Agreement.</p>
	</div>
	<div class="px-5 mt-7">
		<table class="width-tbl-1">
			<tr>
