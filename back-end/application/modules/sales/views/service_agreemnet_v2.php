...
<?php if (isset($type) && $type == 'content_2') { ?>
							...
							<?php
								...
								?>							
									<tr>
										...
										<td class="f-13 " align="right"><?php echo (number_format($item->amount,2) != "0.00" ? "$".number_format($item->amount,2) : ''); ?></td>
									</tr>
							<?php } ?>
							<tr>
	...
	<div class="px-5 pt-2">
		<div class="pad-l-3">
			...
			<ul class="pt-1">
				...
				<li class="f-13 pt-2">Support items with the addition of the letter “T’ are the Temporary Transformation Payment rate.</li>
				...
				<li class="f-13 pt-2">For all Core Supports, there is a two-hour shift minimum.</li>
	...
	<div class="px-5 pt-4">
		<table class="subhead-table">
			<tr>
				<td class="sub-border-bottom"><span class="sub-label-col f-14">House Cleaning and other household tasks</span>
				</td>
			</tr>
		</table>
	</div>
	<div class="px-5 pt-1">
		<div class="pad-l-3">
			<p class="f-13 mt-0">
				All House Cleaning Supports are delivered Monday – Friday, 8am – 6pm only.
			</p>
			<p class="f-13 mt-0">
			...
			<ul class="pt-1">
				<li class="f-13">Supplies - floor cleaner, general cleaner, bathroom cleaner, toilet cleaner, gloves, windex, disinfectant, sponges, cloths, sponges, scrubbing brushes, and paper towel.</li>
				<li class="f-13 pt-2">Equipment – vacuum, mop/bucket, broom, duster </li>
			</ul>
		</div>
	</div>
	...
	<div class="px-5 pt-1">
		<table class="subhead-table">
			<tr>
				<td class="sub-border-bottom"><span class="sub-label-col f-14">Establishment fee for personal care / community access</span>
				</td>
			</tr>
		</table>
	</div>
	<div class="px-5 pt-1">
		<div class="pad-l-3">
			<p class="f-13 mt-0">
				ONCALL claims establishment fees for Daily Living and Participation Supports in line with the NDIS Price Guide. If an establishment fee is applicable, it will be listed in the Schedule of Supports in this Service Agreement.
			</p>
		</div>
	</div>
	<div class="px-5 pt-4">
	...
	<div class="px-5 pt-4">
		<div class="pad-l-3">
			<span class="f-13 f-brown-light">Core Supports</span>
		</div>
	</div>
	<div class="px-5 pt-1">
		<div class="pad-l-3">
	...
	<div class="px-5 pt-1">
		<div class="pad-l-3">
			...
			<ul>
				<li class="f-13 f-bold">Provider Travel non labour costs</li>
			</ul>
			<p class="f-13 mb-0">
			...
			<p class="f-13 mb-0">The Support Coordination  Provider Travel – non labour is claimed using the support item <u class="f-13">Provider Travel – non-labour costs </u>07_799_0106_8_3, this support item is included in your Statement of Supports.
			</p>
			<p class="f-13 mb-0">The Specialist Behavioural Intervention Support  Provider Travel – non labour is claimed using the support item <u class="f-13">Provider Travel – non-labour costs </u>_11_799_0110_7_3, this support item is included in your Statement of Supports. 
			</p>
		</div>
	</div>
	<!-- <pagebreak /> -->
	...
	<div class="px-5 pt-4">
		<div class="pad-l-3">
			<span class="f-13 f-brown-light">Self-Managed or Private Agreement Transport (Kilometres)</span>
			<p class="f-13 mb-0">
			...
			<div class="pt-4">
				<span class="f-13 f-brown-light">Public Transport</span>
			</div>
			<p class="f-13 mb-0 mt-0 pt-2">
...
<!-- 	<pagebreak />
 -->
			...
			<tr class="td-tr-color">
				...
				<td class="td-tr-color">
					...
					<table class="width-tbl-1">
						<tr>
							<td>
								<p class="f-13 pt-2"><br/>If your supports are Plan Managed, ONCALL will share the relevant details of this Service Agreement with your chosen Plan Manager.  This makes sure there is funds for your planned services.</p>
							</td>
						</tr>
						<tr>
							<td>
								<p class="f-13 pt-2">
									Please tell ONCALL if you do not want this information shared with your plan manager.  If you do not want the information shared directly by ONCALL, we will ask you for written confirmation from the Plan Manager that funding is available for ONCALL to deliver planned services.
								</p>
							</td>
						</tr>
					</table>
	...
	<div class="px-5 pt-1">
		<div class="pad-l-3">
			<p class="f-13 mt-0">ONCALL will:</p>
			<ul>
	...
	<div class="px-5 pt-2">
		<table class="sa-input-table sa-input-table-col" border="1">
			...
			<tr>
				...
				<td>
					<p><i><a class="f-13 f-brown" href="https://www.oncall.com.au/feedback">www.oncall.com.au/feedback</a></i></p><br />
	...
	<div class="px-5 pt-2">
		...
		<table class="sa-input-table sa-input-table-col" border="1">
			...
			<tr>
				<td class="f-13" width="30%">Web:</td>
				<td>
					<p><i><a class="f-13 f-brown" href="https://www.ndiscommission.gov.au">www.ndiscommission.gov.au</a></i></p><br />
				</td>
			</tr>
		</table>
	</div>
	<div class="px-5 pt-2">
		...
		<table class="sa-input-table sa-input-table-col" border="1">
			...
			<tr>
				<td class="f-13" width="30%">Web:</td>
				<td>
					<p><i><a class="f-13 f-brown" href="https://www.ndis.gov.au">www.ndis.gov.au</a></i></p><br />
				</td>
			</tr>
		</table>
	</div>
