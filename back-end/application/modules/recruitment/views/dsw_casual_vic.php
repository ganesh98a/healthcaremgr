...
<?php if($type=='employment_content'){ ?>
    ...
    <div>
        ...
        <div class="f-13 pb-3 justify-para"><i>NDIS Worker Screening Check (NDIS WSC)</i></div>
        <div class="f-13 pb-3 justify-para">
            If you have not already obtained an NDIS WSC, you are required to do so before commencing an assignment with any of ONCALL’s clients. 
            You agree to renew your NDIS WSC prior to its expiration (every five years). You must immediately notify ONCALL if your NDIS WSC expires.
        </div>
        <div class="f-13 pb-3 justify-para">
       ...
       <div class="f-13 pb-3 justify-para">
        <i>National Police check</i>
    </div>
    <div class="f-13 pb-3 justify-para">
        If you are being engaged as a labour hire worker providing Child Youth and Family support assignments, you will also be required to provide ONCALL with evidence of a successful national police check clearance, you must do so prior to your first engagement. You agree to renew your police check prior to its expiration on a 12-monthly basis. You understand and accept that if the police check obligation is not met, ONCALL will not be able to place you with any partner organisation or client.
    </div>
    ...
    <div class="f-13 pb-3 justify-para">
        If you have not already obtained a WWCC, you are required to do so before commencing an assignment with any of ONCALL’s clients. You agree to renew your WWCC prior to its expiration (every five years). You must immediately notify ONCALL if your WWCC expires You agree to nominate ONCALL Group Australia as your employer.
    </div>
    <!-- <div class="f-13 pb-3 justify-para">
        <i>DHHF Support Worker Screening Checks</i>
    </div>
    <div class="f-13 pb-3 justify-para">
        All Labour Hire Workers must consent to having their name checked against the Department of Families, Fairness and Housing (DFFH) Disability Worker Exclusion List (DWEL) that is part of the Disability Worker Exclusion Scheme (DWES) and that this information will be provided to ONCALL’s clients as necessary. 
    </div>
    <div class="f-13 pb-3 justify-para">
        You agree to familiarise yourself with DWES by visiting the Department of Families, Fairness and Housing (DFFH) website on:<a href="https://providers.dffh.vic.gov.au/disability-worker-exclusion-scheme">https://providers.dffh.vic.gov.au/disability-worker-exclusion-scheme</a>
    </div> -->
    <div class="f-13 pb-3 justify-para">
        All Labour Hire Workers must consent to having their name checked against the Department of Families Fairness and Housing (DFFH) Disqualified Carer Register as part of the Child Youth & Family Act 2005 (the Act) as required for all out-of-home carers.  
    </div>
    <div class="f-13 pb-3 justify-para">
        You agree to familiarise yourself with the Victorian Carer Register by visiting the Department of Families Fairness and Housing (DFFH) Victorian Carer Register website on:<a href="https://providers.dffh.vic.gov.au/carer-register">https://providers.dffh.vic.gov.au/carer-register</a>
    </div>
    <div class="f-13 pb-3 justify-para">
        By signing this contract it shall be deemed that you understand and comply with the requirements and that you offer your consent to participate in all required worker screening checks.  
    </div>
    <div class="f-13 pb-3 justify-para">
    ...
    <div class="f-13 pb-3 justify-para">
        <div>If you are engaged in NDIS Community Access, Residential Child Youth & Family Support or Transport Shifts, you will be required to hold:</div>
        <div>
            <ul class="pl-3 mt-0">
                <li>a current Victorian eligible driver’s licence;</li>
    ...
    <div class="f-13 pb-3 justify-para">
         While not mandatory for all disability support, it is strongly encouraged for all Labour Hire Staff to have to hold a valid driver’s licence.
    </div>
    ...
    <div class="f-13 pb-3 justify-para">
        ...
        <div>
            Confidential information means all information (whether or not it is described as confidential and whenever acquired) in any form or medium concerning any past, present or future business, operations or affairs of ONCALL or any client of ONCALL including, without limitation:
        </div>
    </div>
    <div class="f-13 pb-3 justify-para">
...
<div class="f-13 pb-3 justify-para">
    ...
    <div>You and ONCALL acknowledge that you may have moral rights within the meaning of the <i>Copyright Act 1968</i> (Cth) in relation to the Intellectual Property. You genuinely consent to all acts or omissions, whether occurring before or after this consent is given, committed by ONCALL, its officers, licensees and successors in title, that may infringe any or all of your moral rights in relation to the Intellectual Property. This consent is irrevocable and does not terminate on termination of your employment or for any other reason.  
    </div>
</div>
...
<div class="f-13 pb-3 justify-para">
    Depending on the nature of the conduct, it may also be necessary for ONCALL to report any such conduct to an appropriate authority, including the Victorian Police, appropriate Victorian Government departments and the National Disability Insurance Agency.  
</div>
<div class="f-13 pb-3 justify-para">
...
<div class="f-13 pb-3 justify-para">
    ...
    <div>You consent to ONCALL collecting, using and disclosing your personal and health information for any lawful purpose relating to your employment. You also consent to ONCALL transferring your personal and health information outside Victoria and Australia in the course of ONCALL's business activities.
    </div>
</div>
<div class="f-13 pb-3 justify-para">
...
<div class="f-13 pb-5 justify-para">
...
<div class="f-13 pb-5">
    <table class="f-13">
        <tr>
            <td width="100px" class="align-top">
                ...
                <div class="f-13 pb-5">
                    ...
                    <div class="f-13 pb-2 justify-para">
                    ...
                    <div class="f-13 pb-3 justify-para ">
                        ...
                        suffered by you which could be accelerated, exacerbated, aggravated or caused to recur or deteriorate by you performing the responsibilities associated with the engagement for which you are applying with ONCALL Group Australia Pty Ltd (ACN 633 010 330) <b>(ONCALL)</b>.
                    </div>
                    <div class="f-13 pb-3 justify-para">
           ...
           <div>
            ...
            <table width="90%" align="center" border="1" class="table_1 f-13">
                <tr>
                    ...
                    <td class="justify-para">All ONCALL staff will act ethically, with integrity, honesty and transparency, and steadfastly adhere to high moral principles and professional standards at all times.
                    </td>
                </tr>
                <tr>
                    <td class="font-weight-bold align-top">Respect</td>
                    <td class="justify-para">All ONCALL Staff will show consideration and treat all people and property with respect. Positively accept and welcome diversity in all people and cultures regardless of any differences, including disability, background, race, religion, gender, sexual identity or age.</td>
                </tr>
                <tr>
                    <td class="font-weight-bold align-top">Accountability</td>
                    <td class="justify-para">We all accept and take personal responsibility for our own actions and behaviours, ensuring we are trustworthy, transparent and meet or exceed assigned tasks, obligations and to admit mistakes.</td>
                </tr>
                <tr>
                    <td class="font-weight-bold align-top">Teamwork </td>
                    <td class="justify-para">We all will strive to work cooperatively and effectively as part of a group, large or small, acting and working together in the interests of a common goal and in line with ONCALL person centred approached.</td>
                </tr>
                <tr>
                    <td class="font-weight-bold align-top">Leadership </td>
                    <td class="justify-para">We will all take a role in leading by example, as individuals, teams and as an organisation within our sector, working toward the achievement of ONCALL’s vision and goals.</td>
                </tr>
                <tr>
                    <td class="font-weight-bold align-top">Commitment to Human Rights</td>
                    <td class="justify-para">We uphold to always treat people with dignity and respect, upholding fundamental rights to which a person is inherently entitled simply because she or he is a human being.</td>
                </tr>
                <tr>
                    <td class="font-weight-bold align-top">Advocacy </td>
                    <td class="justify-para">To act or process of support or defence of a person or cause, including commitment to report any form of abuse or suspected abuse.
                    </td>
                </tr>
                <tr>
                    <td class="font-weight-bold align-top">Professional
                    Boundaries</td>
                    <td class="justify-para">Boundaries are mutually understood, unspoken physical and emotional limits of the relationship between the person being supported and the worker.</td>
                </tr>
            </table>
        </div>
       ...
       <div width="90%" style="margin:0px auto" class="">
        <div class="f-13 justify-para font-weight-bold">Integrity</div>
        <ul class="pl-3 f-13 justify-para set_pading_bottom">
   ...
   <div width="90%" style="margin:0px auto" class="">
    <div class="f-13 justify-para font-weight-bold">Respect</div>
    <ul class="pl-3 f-13 justify-para set_pading_bottom">
    ...
    <div class="f-13  justify-para font-weight-bold">Accountability</div>
    <ul class="pl-3 f-13 justify-para set_pading_bottom">
...
<div class="f-13 font-weight-bold">References</div>
<div class="f-13"><i>DFFH Code of Conduct for Disability Workers</i></div>
<div class="f-13"><i>NDIS Code of Conduct </i></div>
<div class="f-13"><i>Victorian Child Safe Standards</i></div>
<div class="f-13"><i>Freedom from Abuse and Neglect Policy</i></div>
<div class="f-13"><i>Conflict of Interest Policy</i></div>
<div class="f-13"><i>Incident Reporting Procedure</i></div>
<div class="f-13"><i>ONCALL Policies and Procedures</i></div>
</div>
<?php } ?>
<?php if($type=='position_content'){ ?>
    ...
    <table class="table_2 f-13">
        <tr>
            ...
            <td class="font-weight-bold">DISABILITY and/or CHILD YOUTH & FAMILY SUPPORT WORKER</td>
        </tr>
        <tr>
...
required.
                ...
                <TD>
                    <TABLE border="1" class="table_4" cellSpacing="0" cellPadding="0">
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Goals outlined in client/participant support plans successfully achieved and documented.</TD>
                        </TR>
                    </TABLE>
                </TD>
            </TR>
            <TR>
                ...
                <TD>
                    <TABLE border="1" class="table_4" cellSpacing="0" cellPadding="0">
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Ensure you receive and/or provide adequate handover when starting and finishing a shift. In order to do this, make sure all relevant documentation read/complete.</TD>
                        </TR>
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Remember to get your timesheet signed by your Team Leader/client/participant.</TD>
                        </TR>
                    </TABLE>
                </TD>
                <TD>
                    <TABLE border="1" class="table_4" cellSpacing="0" cellPadding="0">
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Take personal responsibility to provide or receive all relevant information during handover.</TD>
                        </TR>
                    </TABLE>
                </TD>
            </TR>
            <TR>
                ...
                <TD>
                    <TABLE border="1" class="table_4" cellSpacing="0" cellPadding="0">
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Personal Care delivered in a way which protects privacy and promotes
dignity.</TD>
                        </TR>
                    </TABLE>
                </TD>
            ...
            <TR>
                ...
                <TD>
                    <TABLE border="1" class="table_4" cellSpacing="0" cellPadding="0">
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Support children/young people to remain in the family home.</TD>
                        </TR>
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Support families to implement routine/boundaries within their own home.</TD>
                        </TR>
                    </TABLE>
                </TD>
                <TD>
                    <TABLE border="1" class="table_4" cellSpacing="0" cellPadding="0">
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Support provided in a way which promotes stability to both the client/participant
and family.</TD>
                        </TR>
                    </TABLE>
                </TD>
            ...
            <TR>
                ...
                <TD>
                    <TABLE border="1" class="table_4" cellSpacing="0" cellPadding="0">
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Ensure you read and understand each client/participant’s medication profiles before administrating medication. When medication is administered, make sure that the medication treatment sheet is documented correctly. It is also important to document if medication is refused by the Client/Participant– this will also involve an incident report.
                            </TD>
                        </TR>
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Ensure all PRN (pro rẽ nata - Latin for as required/needed) is approved by the line manager before administration and documentation is completed. Also remember to update case notes if PRN is administered.</TD>
                        </TR>
                    </TABLE>
                </TD>
                <TD>
                    <TABLE border="1" class="table_4" cellSpacing="0" cellPadding="0">
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Administration, and documentation of Medication is in line with ONCALL’s Medication Policy.</TD>
                        </TR>
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Administration and documentation is in line with Customer Organisations procedure.</TD>
                        </TR>
                    </TABLE>
                </TD>
            </TR>
            <TR>
                ...
                <TD>
                    <TABLE border="1" class="table_4" cellSpacing="0" cellPadding="0">
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Undertake all tasks as required, these may include shopping, cooking, maintenance and cleaning.</TD>
                        </TR>
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">When working in a residential setting, ensure internal/external residence including common areas remain presentable and clean at all times.</TD>
                        </TR>
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Ensure food handling standards and general hygiene is high and in line with food safety and infection control procedures.</TD>
                        </TR>
                        <TR>
                            <TD class="dot_custom">•</TD>
                ...
                <TD>
                    <TABLE border="1" class="table_4" cellSpacing="0" cellPadding="0">
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">House cleaning, food and infection control duties carried out with diligence and due care for personal safety and the safety of others.</TD>
                        </TR>
                    </TABLE>
                </TD>
            </TR>
            <TR>
                ...
                <TD>
                    <TABLE border="1" class="table_4" cellSpacing="0" cellPadding="0">
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Support clients/participants to access and experience the community as required. This may include taking clients/participants shopping, to the movies, to a sporting game, or going out for lunch etc.
                            </TD>
                        </TR>
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">When transporting clients/participants in your personal/company vehicle, you must always carry your valid Victorian Driver’s licence, treat the vehicle with respect, drive safely, adhering to the Victorian Road Rules.</TD>
                        </TR>
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">If using your own vehicle to transport clients, you must ensure your vehicle is registered, roadworthy, insured and serviced in line with ONCALL’s Use of Private Vehicles Policy.</TD>
                        </TR>
                    </TABLE>
                </TD>
                <TD>
            ...
            <TR>
                ...
                <TD>
                    <TABLE border="1" class="table_4" cellSpacing="0" cellPadding="0">
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Take personal responsibility to ensure you always undertake all administrative and documentation activities to a high standard.                   
                            </TD>
                        </TR>
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Ensure all documentation, which includes, but is not limited to: communication books, diaries, medication folders, financial, car log, active night sheets, etc, are completed and up to date as required at the end of each and every shift.                 
                            </TD>
                        </TR>
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Ensure you review relevant house folders (as applicable) eg Casual Folder, Individual Lifestyle Plans, Comprehensive Health Assessment Plans (CHAPS) and Behaviour Support Plans (BSP), Looking after Children (LAC), House Diary, Communication Book, to ensure you understand fully the Client/Participant/house requirements and needs and a consistent approach is taken by all and in line with care team/behaviour
specialists etc requirements.                 
                ...
                <TD>
                    <TABLE border="1" class="table_4" cellSpacing="0" cellPadding="0">
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Records/Documentation (hard /electronic copies) completed professionally and to a high standard (as required) before leaving each shift in accordance with ONCALL’s policies and procedures or the customer organisations requirements.</TD>
                        </TR>
                    </TABLE>
                </TD>
            </TR>
            <TR>
                ...
                <TD>
                    <TABLE border="1" class="table_4" cellSpacing="0" cellPadding="0">
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para"> Follow ONCALL’s Incident Reporting Policy and Procedures and ensure that reporting guidelines are followed, and mandatory reporting timeframes met.                  
                            </TD>
                        </TR>
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">When working through Casual Staff Services you need to report the incident as directed by the Customer Organisation. You should also advise ONCALL and report through OIMs.                  
                            </TD>
                        </TR>
                        <TR>
                            <TD class="dot_custom">•</TD>
                ...
                <TD>
                    <TABLE border="1" class="table_4" cellSpacing="0" cellPadding="0">
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para"> All incidents are managed effectively at the time, ensuring procedures are followed with safety of client/ participant and self/staff is first priority.                 
                            </TD>
                        </TR>
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">All incidents are reported within relevant time frames via the correct channel (CIMS/OIMS).                  
                            </TD>
                        </TR>
                        <TR>
                            <TD class="dot_custom">•</TD>
            ...
            <TR>
                ...
                <TD>
                    <TABLE border="1" class="table_4" cellSpacing="0" cellPadding="0">
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Take personal responsibility to undertake all activities in line with safe working practices in accordance with OH&S legislation.
                            </TD>
                        </TR>
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Be on the lookout for potential hazards. Report all hazards, incidents, injuries and
near misses to your manager/ONCALL.</TD>
                ...
                <TD>
                    <TABLE border="1" class="table_4" cellSpacing="0" cellPadding="0">
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Comply with all ONCALL’s OH&S policies, protocols and safe work procedures and legislation.</TD>
                        </TR>
                    </TABLE>
                </TD>
            </TR>
            <TR>
                ...
                <TD>
                    <TABLE border="1" class="table_4" cellSpacing="0" cellPadding="0">
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Always use designated equipment if required,
e.g. personal protection equipment or manual handling/lifting equipment. Never take risks or shortcuts that will put your own safety at risk.</TD>
                ...
                <TD>
                    <TABLE border="1" class="table_4" cellSpacing="0" cellPadding="0">
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Work, Health and Safety instructions/procedures are followed, and all injuries/hazards
reported.</TD>
                        </TR>
                    </TABLE>
                </TD>
            ...
            <TR>
                ...
                <TD>
                    <TABLE border="1" class="table_4" cellSpacing="0" cellPadding="0">
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Certificate IV Disability or relevant qualification and equivalent experience and/or successful completion of NDIS Job Ready Program.</TD>
                        </TR>
                    </TABLE>
                </TD>
                <TD>
                    <TABLE border="1" class="table_4" cellSpacing="0" cellPadding="0">
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD class="justify-para">Certificate IV in Child Youth Family Intervention, or a recognised relevant qualification and the four mandatory top up
units.</TD>
                        </TR>
                    </TABLE>
                </TD>
        ...
        <div class="f-13 pb-3 justify-para">
            ...
            <ul class="font-weight-bold justify-para">
...
<div class="f-13 pb-3 justify-para">
    <div class="pb-2"><i>DFFH Code of Conduct for Disability Workers (2018)</i></div>
...
<div>
    ...
    <div class="f-13 pb-4 justify-para">See our privacy policy at <a href="https://www.oncall.com.au/privacy-policy/">https://www.oncall.com.au/privacy-policy/</a> for details about how we use, disclose and protect your records and other information.  The privacy policy also tells you how you can  make a  complaint and has  contact details  you  can use to ask for accessor  correction  of your information.  </div>
