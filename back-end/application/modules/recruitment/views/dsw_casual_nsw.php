...
<?php if($type=='employment_content'){ ?>
    ...
    <div class="f-13 pb-3 justify-para">
        <i>Working With Children Check</i>
    </div>
    <div class="f-13 pb-3 justify-para">
    If you have not already obtained a WWCC, you may be required to do so before commencing a placement with any of ONCALL’s clients. This is in accordance with the 'No Card, No Start laws' in NSW. You agree to renew your WWCC Card prior to its expiration (usually every Five years). 
    </div>
    <div class="f-13 pb-3 justify-para">
    You must immediately notify ONCALL if your WWCC expires. If you do not apply to renew your WWCC Card by the time it expires, you will be subject to the No Card, No Start laws and ONCALL will not be able to offer you work.
    </div>
    <div class="f-13 pb-3 justify-para">
    You agree to familiarise yourself with the WWCC requirements by visiting the Service NSW website at:
    <a href="https://www.service.nsw.gov.au/transaction/apply-working-children-check">https://www.service.nsw.gov.au/transaction/apply-working-children-check</a>
    </div>
    
    <div class="f-13 pb-3 justify-para">
        <i>NDIS Worker Screening Clearance</i>
    </div>    
    <div class="f-13 pb-3 justify-para">
    ...
    <div class="f-13 pb-3 justify-para">
    You agree to familiarise yourself with the Service NSW Disability Worker Screening requirements by visiting the website at 
    <a href="https://www.service.nsw.gov.au/ndiswc">https://www.service.nsw.gov.au/ndiswc</a>
    </div>
    <div class="f-13 pb-3 justify-para">
    ...
    <div class="f-13 pb-3 justify-para">
        ...
        <div>
            <ul class="pl-3 mt-0">
                <li>a current NSW or other eligible driver’s licence;</li>
    ...
    <div class="f-13 pb-3 justify-para">
    If you are engaged in Disability Support, a NSW or other eligible driver’s licence is required for residential and NDIS community access shifts, and while not mandatory is strongly encouraged for all Disability Support.
    </div>
    <pagebreak />
    <div class="f-13 pb-3 justify-para">
...
<div class="f-13 pb-3 justify-para">
Depending on the nature of the conduct, it may also be necessary for ONCALL to report any such conduct to an appropriate authority, including the NSW Police, appropriate NSW Government departments and the National Disability Insurance Agency.  
</div>
<pagebreak />
<div class="f-13 pb-3 justify-para">
...
<div class="f-13 pb-3 justify-para">
    ...
    <div>You consent to ONCALL collecting, using and disclosing your personal and health information for any lawful purpose relating to your employment. You also consent to ONCALL transferring your personal and health information outside NSW and Australia in the course of ONCALL's business activities.
    </div>
</div>
<div class="f-13 pb-3 justify-para">
...
<div class="f-13 pb-3 justify-para">
    This Agreement shall be governed by and construed in accordance with the laws of the State of NSW.
</div>
<div class="f-13 pb-3 justify-para">
...
<div><i>(To confirm your acceptance of this position please sign and return one copy (keeping one for your records).</i></div>
...
smile.</li>
            <li>Remembering to bring with you, your ONCALL ID card, NDIS disability worker screening clearance / Yellow Card / WWCC (as applicable), NSW Driver’s License, timesheet book and mobile phone.</li>
...
fully ready and across all changes and support requirements.</li>
    ...
    <div class="f-13 justify-para">
        <ul class="pl-3 set_pading_bottom">
            <li>If working within an ONCALL run service (e.g. Accommodation Services Disability or OOHC or NDIS) – if your house supervisor is not available/on shift, then always remember to call ONCALL directly (03) 1300 962 468 and speak to your Consultant or Coordinator or call the ONCALL After Hours</li>
            ...
            <TR>
                ...
                <TD>
                    <TABLE border="1" class="table_4 justify-para" cellSpacing="0" cellPadding="0">
                        ...
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD>When transporting clients/participants in your personal/company vehicle, you must always carry your valid NSW Driver’s licence, treat the vehicle with respect, drive safely, adhering to the NSW Road Rules. </TD>
                        </TR>
                        <TR>
                            <TD class="dot_custom">•</TD>
            ...
            <TR>
                ...
                <TD>
                    <TABLE border="1" class="table_4 justify-para" cellSpacing="0" cellPadding="0">
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD>NDIS worker screening clearance (5 yearly renewal) / NSW Disability worker screening clearance (3 yearly renewal)     </TD>
                        </TR>
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD>WWCC (5 yearly renewal)</TD>
                        </TR>
                        <TR>
                            <TD class="dot_custom">•</TD>
                ...
                <TD>
                    <TABLE border="1" class="table_4 justify-para" cellSpacing="0" cellPadding="0">
                        ...
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD>NDIS worker screening clearance ( 5 yearly renewal) / NSW Disability worker screening clearance / Yellow Card</TD>
                        </TR>
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD>International police check (if applicable)</TD>
                        ...
                        <TR>
                            <TD class="dot_custom">•</TD>
                            <TD>Current NSW Driver's Licence  
                            </TD>
                        </TR>
                        <TR>
                            <TD class="dot_custom">•</TD>
...
units.</TD>
        ...
        <div class="f-13 pb-3 justify-para pt-3">
        ALL ONCALL employees must take personal responsibility for keeping mandatory training/documents current and are required to send new certificates to <a href="status@oncall.com.au">status@oncall.com.au</a> prior to expiry date (ONCALL will send you reminders). Where mandatory requirement expires, you will be considered non-compliant and unable to work.
        </div>
        <pagebreak />       
        <div class="f-13 pb-3 justify-para">
        ...
        <div class="f-13 pb-3 justify-para">
            ...
            <ul class="font-weight-bold">
                ...
                <li>I have read, understood and agree to abide by the NDIS Code of Conduct</li>
            </ul>
        </div>
